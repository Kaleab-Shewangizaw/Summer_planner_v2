...
export default function Folder({
  ...
  return (
    <div className={`text-gray-200 bg-blue-900/20 relative ${show && ""}`}>
      {showOptions && (
      ...
      <div
        className="flex w-full justify-between  font-bold cursor-pointer   py-3 px-2 hover:bg-blue-800/20"
        onDoubleClick={() => {
          ...
          >
            ...
            {projects.map((project, i) => {
              return (
                <h1
                  key={i}
                  className="hover:bg-gray-800 py-2 px-2 pl-9 transition-all duration-200  rounded-sm min-w-fit cursor-pointer"
                >
                  {project.name}
                </h1>
              );
